...
class PermisoTest(TestCase):
    ...
    def test_creacion_permiso(self):
        print "Prueba de creacion de la clase Permiso"
        print ""
        ...
        print "Prueba de creacion de la clase Permiso sin errores\n"
...
class RolTest(TestCase):
    ...
    def test_creacion_rol(self):
        print "Prueba de creacion de la clase Rol"
        print ""
        r = self.crear_rol()
        ...
        print "Prueba de creacion de la clase Rol sin errores\n"
...
class TipoAtributoTest(TestCase):
    ...
    def test_creacion_tipo_atributo(self):
        print "Prueba de creacion de la clase TipoAtributo"
        print ""
        ...
        print "Prueba de creacion de la clase TipoAtributo sin errores\n"
